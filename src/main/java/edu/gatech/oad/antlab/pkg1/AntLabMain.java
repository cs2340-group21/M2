 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
          ...
          Person1 p1 = new Person1("Alex Hirschberg");
          toPrint += p1.toString("ahirschberg3");
          //Person2 replace P2 with your name
          //and gburdell with your gt id
          Person2 p2 = new Person2("Hank Grogan");
          toPrint += p2.toString("rgrogan3");
          //Person3 replace P3 with your name
          //and gburdell3 with your gt id
          Person3 p3 = new Person3("Jeremy DiBattista");
          toPrint += p3.toString("jdibattista3");
          //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("Zack Mudge");
          toPrint += p4.toString("zmudge3");
          //Person5 replace P4 with your name
          //and gburdell5 with your gt id
          Person5 p5 = new Person5("Joseph Duda");
          toPrint += p5.toString("jduda7");
